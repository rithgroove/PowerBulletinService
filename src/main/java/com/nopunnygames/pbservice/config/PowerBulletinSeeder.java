...
public class PowerBulletinSeeder implements CommandLineRunner {
    ...
    private void seedEffects() {
        ...
        upsertEffect("77777777-7777-5777-8777-777777777771", "HERO_HEALER_MARIE_V1", "power_bulletin.effects.implementations.power_bulletin_v1.hero_healer_marie_v1_effect.HeroHealerMarieV1Effect", "Hero Healer Marie v1", "Target opponent draws one card. Active player draws two on their next draw step.");
        ...
        upsertEffect("77777777-7777-5777-8777-777777777772", "HERO_ATTACKER_YOUNG_COOPER_V1", "power_bulletin.effects.implementations.power_bulletin_v1.hero_attacker_young_cooper_v1_effect.HeroAttackerYoungCooperV1Effect", "Hero Attacker Young Cooper v1", "Target opponent discards up to two chosen cards, then draws one card.");
    ...
    private void seedCards() {
        ...
        upsertCard("77777777-7777-4777-8777-777777777771", "HERO_HEALER_MARIE", "HEALER", "Marie", Faction.HERO, "77777777-7777-4777-8777-777777777772", CardType.ACTION, "Target opponent draws 1 card. Draw 2 on your next draw step.", "77777777-7777-4777-8777-777777777773", List.of(2, 2, 3, 4));
        ...
        upsertCard("77777777-7777-4777-8777-777777777774", "HERO_ATTACKER_YOUNG_COOPER", "ATTACKER", "Young Cooper", Faction.HERO, "77777777-7777-4777-8777-777777777775", CardType.ACTION, "Target opponent discards 2 cards, then draws 1 card.", "77777777-7777-4777-8777-777777777776", List.of(3, 4, 4, 5));
    ...
    private void seedProducts() {
        ...
        Product flashback = upsertProduct("FLASHBACK_EXPANSION", "Flashback Expansion", "Flashback-era Power Bulletin cards.", ProductType.EXPANSION, 25);
        flashback.setReleaseStatus(ProductReleaseStatus.DRAFT);
        flashback = productRepository.save(flashback);
        sortOrder = 1;
        for (String printSetCode : List.of("HERO_HEALER_MARIE_V1_STANDARD", "HERO_ATTACKER_YOUNG_COOPER_V1_STANDARD")) {
            upsertProductItem(flashback, printSetCode, sortOrder++);
        }
